# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 17:39:47 2020
...
wd = "C:/Users/kbhandari/OneDrive - Epsilon/Desktop/Not Just OLS/Apriori/"
model = Apriori(minSupp = 0.2, minConf = 0.5)
data = model.getTransListSet(filePath = wd+'transaction.csv')
apriori_rules = model.fit(wd+'transaction.csv')
list_of_rules = model.getSpecRules({'Milk'})
